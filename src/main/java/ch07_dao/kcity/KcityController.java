...
public class KcityController extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		case "list":
			...
			int num = (num_ == null || num_.equals("")) ? 50 : Integer.parseInt(num_);
		...
		case "insert":
			if (method.equals("GET")) {
				...
				response.sendRedirect("/jw/ch07/kcity/list?district=" + district + "&limit=30&offset=0");
			}
			break;
		...
		case "delete":
			id = Integer.parseInt(request.getParameter("id"));
			cDao.deleteCity(id);
			response.sendRedirect("/jw/ch07/kcity/list?district=Kyonggi&limit=30&offset=0");
